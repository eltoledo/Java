...
public class FeatureService {
    ...
    public Feature toFeatureById(long id) {
    ...
    public Feature toListByProductId(long productId) {
     ...
     public List<Feature> toListProductIdActiveOrderBy(long productId) {
        return featureRepository.findAllByProductIdActiveOrderBy(productId);
    }
}
